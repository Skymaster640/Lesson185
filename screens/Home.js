        ...
        return(
            <View style = {styles.container}>
                ...
                <View style = {styles.contentContainer}>
                    <View style = {{flex:0.5,}}>
                        <Text style = {styles.contentText}>Experience the Virtual Experience of Trying Out Different Frames from our Wide Collection on your Mobile Device before making any purchases, just how you would on an online store.</Text>
